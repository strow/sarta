...
C
       PARAMETER(FNCOF1=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set1.dat')
C       PARAMETER(FNCOF1=
C     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set1_m130x385.dat')
       PARAMETER(FNCOF2=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/set6.dat')
       PARAMETER(FNCOF7=
...
C     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/CO2_5term_m140x385.dat')
     ...
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/nh3.dat')
       PARAMETER(FNHDO =
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/hdo.dat')

C
       PARAMETER(FNFX  =
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/refprof_nh3')
       PARAMETER(FNSUN =
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Solar/solar_m140.txt')
C
       PARAMETER(FNTHER=
...
C
       PARAMETER(FNTMLT=
     $ '/home/chepplew/data/sarta/prod_2019/airs_l1c/dec2018/dbase/Coef/'
     $ // 'tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
