...
C       PARAMETER(MXCHNC = 893)
C       PARAMETER(  NCO2 = 5)       ! was 4-term. otherwise 5-term
C
C
C      ----------------------
C      For SO2
...
C       PARAMETER(MXCHNS = 295)   ! was 295
C       PARAMETER(  NSO2 = 4)     ! was 4
...
C       PARAMETER(MXCHNW = 873)   ! CrIS HR g4
