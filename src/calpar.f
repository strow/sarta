...
C      =================================================================
     ...
     $    RTEMP,RFAMNT,RWAMNT,ROAMNT,RCAMNT,RMAMNT,RSAMNT,RHAMNT,
     $   RNAMNT,RAAMNT, PTEMP,PFAMNT,PWAMNT,POAMNT,PCAMNT,PMAMNT,
     $   PSAMNT,PHAMNT,PNAMNT,PAAMNT,PRES,SECANG, ALAT, FX, DZREF,
