...
ccc      https://docs.oracle.com/cd/E19957-01/805-4939/6j4m0vnb3/index.html
      ...
      SUBROUTINE WaterJac(*,IWVZLAYJAC,IDOWVZJAC,IOUNJ,IPROF,LBOT,NCHAN,DST,DQ,
     $       PSURF,PLAY,TEMPRAW,      
...
C      for CALT
       ...
       INTEGER IWVZLAYJAC,IDOWVZJAC,IOUNJ,IPROF,LBOT,NCHAN
...
c------------------------------------------------------------------------
 ...
 771     CONTINUE
         IDOWVZJAC = IDOWVZJAC * -1
	 IF ((IDOWVZJAC .GT. 0) .AND. (IWVZLAYJAC .LT. LBOT)) THEN
