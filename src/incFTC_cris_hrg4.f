...
C
       PARAMETER(FNCOF1='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set1_hrg4.dat')
c       PARAMETER(FNCOF1='../Data/set1_uncut.dat')
c       PARAMETER(FNCOF1='../Data/dummy_set1.dat')
C
       PARAMETER(FNCOF2='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set2_hrg4.dat')
c       PARAMETER(FNCOF2='../Data/set2_uncut.dat')
c       PARAMETER(FNCOF2='../Data/dummy_set2.dat')
C
       PARAMETER(FNCOF3='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set3_hrg4.dat')
c       PARAMETER(FNCOF3='../Data/set3_uncut.dat')
C
       PARAMETER(FNCOF4='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set4_hrg4.dat')
c       PARAMETER(FNCOF4='../Data/set4_uncut.dat')
c       PARAMETER(FNCOF4='../Data/dummy_set4.dat')
C
       PARAMETER(FNCOF5='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set5_hrg4.dat')
c       PARAMETER(FNCOF5='../Data/set5_uncut.dat')
c       PARAMETER(FNCOF5='../Data/dummy_set5.dat')
C
       PARAMETER(FNCOF6='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set6_hrg4.dat')
c       PARAMETER(FNCOF6='../Data/set6_uncut.dat')
c       PARAMETER(FNCOF6='../Data/dummy_set6.dat')
C
       PARAMETER(FNCOF7='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/set7_hrg4.dat')
c       PARAMETER(FNCOF7='../Data/set7_uncut.dat')
c       PARAMETER(FNCOF7='../Data/dummy_set7.dat')
C
       PARAMETER(FNCO2='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/co2_hrg2.dat')
...
C
       PARAMETER(FNOPTR='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/optran_hrg4.dat')
...
C
       PARAMETER(FNN2O='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/n2o_hrg4.dat')
       PARAMETER(FNCOFN='/asl/s1/chepplew/data/sarta_database/Data_CrIS_HR_mar16/Coef/nte_7term_hrg2.dat')
C
       PARAMETER(FNTHER='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/therm_hrg4.dat')
C
       PARAMETER(FNFX='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/fx.txt')
C       PARAMETER(FNPREF='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Coef/profref_truJul00')
       PARAMETER(FNPREF='/asl/data/sarta_database/Data_IASI_may09/Coef/profref_trace385')
       PARAMETER(FNSUN='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_may16/Solar/sol_hrg4.txt')
C
C
