...
C
C       PARAMETER(FNCO2='/asl/data/sarta_database/Data_CrIS_sep16/Coef/co2.dat')
...
C
c       PARAMETER(FNN2O='/asl/data/sarta_database/Data_CrIS_sep16/Coef/n2o.dat')
c       PARAMETER(FNSO2='/asl/data/sarta_database/Data_CrIS_sep16/Coef/so2.dat')
c       PARAMETER(FNHNO3='/asl/data/sarta_database/Data_CrIS_sep16/Coef/hno3.dat')
c       PARAMETER(FNTHER='/asl/data/sarta_database/Data_CrIS_sep16/Coef/therm.dat')
c       PARAMETER(FNCOFN='/asl/data/sarta_database/Data_CrIS_sep16/Coef/nte_7term.dat')
C
