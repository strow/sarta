...
C 12 Jul 2022 C Hepplewhite For use with prod_2022, jul2022 fast coefs. dev
C  9 Aug 2022 C Hepplewhite Added DIAGNT (diagnostic) logical switch for 
C                            dumping rads vs layer.
C 18 Aug 2022 C Hepplewhite Includes extended nonLTE (xnte) references
!END====================================================================
C
C-----------------------------------------------------------------------
C      IMPLICIT NONE
...
C      version template    '#.## YYYY-MM-DD <------comment--------->'
       ...
       PARAMETER( VSCOEF = 'IASI prod_2022 jul22. con1 gauss 2cm')
...
C       PARAMETER(MXCHNA = 1)        ! placeholder when not using this
C       set
C       PARAMETER( NNH3 = 1)         ! placeholder when not using this
C       set
...
C       PARAMETER(MXCHND = 1)        ! placeholder when not using this
C       set
...
C      --------------------
       ...
       PARAMETER(MXCNTE = 682)  !  # 664,684
       PARAMETER(NNCOEF = 14)    !  #7 for nom nonLTE, 2x7=14 for xnte.
       PARAMETER(NTEBOT = 10)
...
C
       PARAMETER(FNCOF1=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set1.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set2.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set3.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set4.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set5.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set6.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/set7.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/set7.dat')
C
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/optran.dat')
       PARAMETER(FNCO2 =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/co2.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/so2.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/hno3.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/n2o.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/n2o.dat')
       PARAMETER(FNNH3 =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/nh3.dat')
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/nh3.dat')
       PARAMETER(FNHDO =
C     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/hdo.dat')
     ...
     $ '/home/chepplew/data/sarta/prod_2020/iasi/feb2020/fitc/r49/thermFactor_iasi.dat')
       PARAMETER(FNCOFN=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/xnte_2x7term.dat')
CCCC     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/nte_7term.dat')
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/refprof_nh3')
CCCC    profref_trace400')
       PARAMETER(FNSUN =
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Solar/solardata.txt')
...
C
       PARAMETER(FNTMLT=
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
