...
C
       PARAMETER(FNCOF1='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set1g4.dat')
c       PARAMETER(FNCOF1='../Data/set1_uncut.dat')
c       PARAMETER(FNCOF1='../Data/dummy_set1.dat')
C
       PARAMETER(FNCOF2='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set2g4.dat')
c       PARAMETER(FNCOF2='../Data/set2_uncut.dat')
c       PARAMETER(FNCOF2='../Data/dummy_set2.dat')
C
       PARAMETER(FNCOF3='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set3g4.dat')
c       PARAMETER(FNCOF3='../Data/set3_uncut.dat')
C
       PARAMETER(FNCOF4='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set4g4.dat')
c       PARAMETER(FNCOF4='../Data/set4_uncut.dat')
c       PARAMETER(FNCOF4='../Data/dummy_set4.dat')
C
       PARAMETER(FNCOF5='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set5g4.dat')
c       PARAMETER(FNCOF5='../Data/set5_uncut.dat')
c       PARAMETER(FNCOF5='../Data/dummy_set5.dat')
C
       PARAMETER(FNCOF6='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set6g4.dat')
c       PARAMETER(FNCOF6='../Data/set6_uncut.dat')
c       PARAMETER(FNCOF6='../Data/dummy_set6.dat')
C
       PARAMETER(FNCOF7='/asl/data/sarta_database/Data_CrIS_sep16/Coef/set7g4.dat')
c       PARAMETER(FNCOF7='../Data/set7_uncut.dat')
c       PARAMETER(FNCOF7='../Data/dummy_set7.dat')
C
       PARAMETER(FNCO2='/asl/data/sarta_database/Data_CrIS_sep16/Coef/co2g4.dat')
c       PARAMETER(FNCO2 ='../Data/rawcoef_co2_fowp.dat')
c       PARAMETER(FNCO2 ='../Data/dummy_co2.dat')
C
       PARAMETER(FNOPTR='/asl/data/sarta_database/Data_CrIS_sep16/Coef/optrang4.dat')
c       PARAMETER(FNOPTR='../Data/optran_uncut.dat')
c       PARAMETER(FNOPTR='../Data/dummy_optran.dat')
C
       PARAMETER(FNN2O='/asl/data/sarta_database/Data_CrIS_sep16/Coef/n2og4.dat')
       PARAMETER(FNSO2='/asl/data/sarta_database/Data_CrIS_sep16/Coef/so2g4.dat')
       PARAMETER(FNHNO3='/asl/data/sarta_database/Data_CrIS_sep16/Coef/hno3g4.dat')
       PARAMETER(FNTHER='/asl/data/sarta_database/Data_CrIS_sep16/Coef/thermg4.dat')
       PARAMETER(FNCOFN='/asl/data/sarta_database/Data_CrIS_sep16/Coef/nte_7termg4.dat')
C
       PARAMETER(FNFX='/asl/data/sarta_database/Data_CrIS_sep16/Coef/fx.txt')
       PARAMETER(FNPREF='/asl/data/sarta_database/Data_CrIS_sep16/refprof_regr49_1100_400ppm_b')
       PARAMETER(FNSUN='/asl/data/sarta_database/Data_CrIS_sep16/Solar/solg4.txt')
C
C
...
C
       PARAMETER(FNTMLT='/asl/data/sarta_database/Data_CrIS_sep16/Coef/tunmlt_hrg4.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
