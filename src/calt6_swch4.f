...
C    AIRS
C
C    CALT6 (set6=FWO sun mfmw) version for trace gases (CO2 SO2 N2O HDO)
C          (no HNO3, NH3)
C          with s/w CH4
C
!F77====================================================================
...
C       INDN2O, COFN2O, N2OMLT, INDHDO, COFHDO, HDOMLT,
C       INDCH4, COFCH4, CH4MLT, XZ, TAU, TAUZ )
...
C  1 Jun 2022 C Hepplewhite  Added s/w CH4 per Scott.
