...
C      Used in part by modules: 12, 11, 10, 9, 7, 6, 5, 2b, 1b, 2a
       ...
       PARAMETER(MXCHNC = 1)    ! placeholder
       PARAMETER(  NCO2 = 5)
C
C
C      ----------------
...
C      -----------------
       ...
       PARAMETER(MXCHNN = 1)       ! Placeholder
       PARAMETER(  NN2O = 7)
C
C
C      ----------------------
...
C
     ...
     $ '/home/chepplew/data/sarta/prod_2019/cris_hr/dec2018/dbase/Coef/fx.txt')
       PARAMETER(FNPREF =
     $ '/home/chepplew/data/sarta/prod_2019/cris_hr/dec2018/dbase/Coef/profref_tr400')
       PARAMETER(FNSUN =
...
C
     ...
     $ '/home/chepplew/data/sarta/prod_2019/cris_hr/dec2018/dbase/Coef/therm.dat')
       PARAMETER(FNCOFN =
     $ '/home/chepplew/data/sarta/prod_2019/cris_hr/dec2018/dbase/Coef/nte.dat')
C
C
