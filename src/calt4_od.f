...
!CALL PROTOCOL:
C    CALT4(ISELECTLAY, INDCHN, NLAY, NCHN4, CLIST4, COEF4,
C       FIXMUL, CONPD4, FPRED4, CPRED4, OPRED4, WPRED4, TRCPRD, INDCO2,
C       COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT, TAU, TAUZ )
...
C       TAU = [ k_con + k_fixed + k_co + k_ozone + k_water ]
C
C    ===================================================================
...
C 03 Feb 1997 Scott Hannon   Re-wrote (from CALTAU) for FCOW
C 03 Sep 1997 Scott Hannon   Re-wrote for sun and added TAUZ & BLMULT
...
C      =================================================================
       SUBROUTINE XCALT4 (ISELECTLAY, INDCHN, NLAY, NCHN4, CLIST4,
