...
C       CO2MLT, INDN2O, COFN2O, N2OMLT, INDCH4, COFCH4, CH4MLT,
C       XZ, TAU, TAUZ )
...
C    INT arr   INDCH4  CH4 pert chan indices       none
C    REAL arr  COFCH4  CH4 pert coefs              various
C    REAL arr  CH4MLT  CH4 pert multiplier         none
...
C  1 Jun 2022 C Hepplewhite  Add s/w CH4 per Scott.
...
C         Determine whether or not to do variable HDO calc
          ...
          ENDIF
C
C         Determine whether or not to do variable CH4
...
C     $               ( COFHDO(2,ILAY,IHDO)*DPRED( 2,ILAY) ) +
C     $               ( COFHDO(3,ILAY,IHDO)*DPRED( 3,ILAY) ) +
C     $               ( COFHDO(4,ILAY,IHDO)*DPRED( 4,ILAY) ) +
C     $               ( COFHDO(5,ILAY,IHDO)*DPRED( 5,ILAY) ) +
C     $               ( COFHDO(6,ILAY,IHDO)*DPRED( 6,ILAY) ) +
C     $               ( COFHDO(7,ILAY,IHDO)*DPRED( 7,ILAY) ) +
C     $               ( COFHDO(8,ILAY,IHDO)*DPRED( 8,ILAY) ) +
...
C            ----------------------------
C            Calc change in total optical
C            depth due to variable CH4
C            ----------------------------
             IF (LCH4 .AND. CH4MLT(ILAY) .NE. 0.0) THEN
