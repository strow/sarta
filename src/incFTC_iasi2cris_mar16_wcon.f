...
C
       PARAMETER(FNCOF1=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/set7.dat')
C
       PARAMETER(FNOPTR=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/n2o.dat')
C
       PARAMETER(FNTHER=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/therm.dat')
       PARAMETER(FNCOFN=
     $ '/asl/s1/chepplew/data/sarta_database/Data_i2c_Mar16/Coef/nte_7term.dat')
       PARAMETER(FNFX  =
