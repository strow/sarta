...
C  3 Feb 2004 Scott Hannon   Updated for "cc2"
C 19 Feb 2004 Scott Hannon   Add FNTMLT & update VSARTA for v1.05
...
C 30 Mar 2006 Scott Hannon   Change from separate MI#* for each cloud
C                            type to a single MIE* 3-D array for all
C                            types, and add MIETYP & NMIETY.
C 02 May 2007 Scott Hannon   Added XSALT
C 12 May 2009 Scott Hannon   Add VTUNNG; delete VCLOUD
C 07 Dec 2017 Sergio Machado Scattering for CrIS HiRes
...
C      version template    '#.## YYYY-MM-DD <--------comment------->'
       PARAMETER( VSARTA = '1.08 2017-12-07 rtpV201 PCLSAM slab HG3')
...
c       PARAMETER( CO2STD = 370.0 )  ! m130x, m140x
