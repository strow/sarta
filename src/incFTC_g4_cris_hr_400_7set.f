...
C
       ...
       PARAMETER(FNTHER='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_400ppm/Coef/thermg4.dat')
       PARAMETER(FNCOFN='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_400ppm/Coef/nte_7termg4.dat')
C
