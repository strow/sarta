...
C       PARAMETER(FNTHER='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_400ppm/Coef/therm.dat')
...
C       PARAMETER(FNPREF='/asl/data/sarta_database/Data_IASI_sep08/Coef/profref_trace385')
       PARAMETER(FNPREF='/asl/s1/chepplew/data/sarta_database/Data_CrIS_hrg4_400ppm/refprof_regr49_1100_400ppm_b')
