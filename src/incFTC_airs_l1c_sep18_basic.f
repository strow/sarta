...
C      -----------------------------------
       ...
       INTEGER MXCHAN ! max total # of channels (2645)
...
C      Used in part by modules: 12, 11, 10, 9, 8, 7, 6, 5, 3, 4b, 4a
       INTEGER MXCHN1 ! max # of channels for set1 = FWO (1281)
...
C
       PARAMETER(FNCOF1=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/set7.dat')
       PARAMETER(FNOPTR=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/n2og4.dat')
C
       PARAMETER(FNFX  =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/refprof_nh3')
       PARAMETER(FNSUN =
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Solar/sol.txt')
C
       PARAMETER(FNTHER=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/therm.dat')
       PARAMETER(FNCOFN=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/nte.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/home/chepplew/data/sarta/prod_2018/airs_l1c_sep18/Coef/'
     $ // 'tunmlt.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
