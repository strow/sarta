...
C    Aug 2020 C Hepplewhite  New directory structure asl/data -> /asl/rta
C                            Updated logic and hooks.
...
C
       PARAMETER(FNCOF1=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/set7.dat')
C
       PARAMETER(FNOPTR=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/n2o.dat')
C
       PARAMETER(FNTHER=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/therm.dat')
       PARAMETER(FNCOFN=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/nte_7term.dat')
       PARAMETER(FNFX  =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/home/chepplew/data/sarta/prod_2009/cris/dbase/Coef/profref_trace385_nh3')
c$$$     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/profref_trace385')
       PARAMETER(FNSUN =
     $ '/asl/rta/sarta_database/Data_IASI_may09/Solar/solardata.txt')
...
C
       PARAMETER(FNTMLT=
     $ '/asl/rta/sarta_database/Data_IASI_may09/Coef/'
     $ // 'tunmlt_wcon_nte.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
