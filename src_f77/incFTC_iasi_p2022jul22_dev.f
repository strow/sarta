...
C
       ...
       PARAMETER( XSALT = 825.0 )    ! was 817 or 825
C
C      -----------------------------------
...
C     $ '/asl/data/sarta_database/Data_IASI_may09/Coef/set5.dat')
       PARAMETER(FNCOF6=
...
C     $ '/asl/data/sarta_database/Data_IASI_may09/Coef/co2.dat')
       PARAMETER(FNSO2 =
...
C     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/hdo.dat')
     ...
     $ '/home/chepplew/data/sarta/prod_2020/iasi/feb2020/fitc/r49/thermFactor_iasi.dat')
       PARAMETER(FNCOFN=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/nte_7term.dat')
CCCC     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/nte_7term.dat')
       PARAMETER(FNFX  =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/refprof_trace400')
       PARAMETER(FNSUN =
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Solar/solardata.txt')
...
C
       PARAMETER(FNTMLT=
     $ '/home/chepplew/data/sarta/prod_2022/iasi/jul2022/dbase/Coef/tunmlt_ones.txt')
C     $ '/asl/data/sarta_database/Data_IASI_may09/Coef/tunmlt_wcon_nte.txt')
C      '
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
