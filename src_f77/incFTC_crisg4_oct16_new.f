...
C
       PARAMETER(FNCOF1='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set1.dat')
       PARAMETER(FNCOF2='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set2.dat')
       PARAMETER(FNCOF3='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set3.dat')
       PARAMETER(FNCOF4='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set4.dat')
       PARAMETER(FNCOF5='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set5.dat')
       PARAMETER(FNCOF6='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set6.dat')
       PARAMETER(FNCOF7='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/set7.dat')
       PARAMETER(FNCO2='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/co2.dat')
       PARAMETER(FNOPTR='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/optran.dat')
       PARAMETER(FNN2O='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/n2o.dat')
       PARAMETER(FNSO2='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/so2.dat')
       PARAMETER(FNHNO3='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/hno3.dat')
       PARAMETER(FNNH3='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/nh3.dat')
       PARAMETER(FNHDO='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/hdo.dat')
       PARAMETER(FNTHER='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/therm.dat')
       PARAMETER(FNCOFN='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/nte_7term.dat')
       PARAMETER(FNFX='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/fx.txt')
       PARAMETER(FNPREF='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/refprof_400_tra')
       PARAMETER(FNSUN='/asl/rta/sarta_coef/Data_CrIS_oct16/Solar/sol.txt')
...
C
       PARAMETER(FNTMLT='/asl/rta/sarta_coef/Data_CrIS_oct16/Coef/tunmlt.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
