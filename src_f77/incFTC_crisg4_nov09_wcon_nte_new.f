...
C
       PARAMETER(FNCOF1=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set1g4.dat')
       PARAMETER(FNCOF2=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set2g4.dat')
       PARAMETER(FNCOF3=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set3g4.dat')
       PARAMETER(FNCOF4=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set4g4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/set7g4.dat')
       PARAMETER(FNOPTR=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/optrang4.dat')
C
       PARAMETER(FNCO2 =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/co2g4.dat')
       PARAMETER(FNSO2 =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/so2g4.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/n2og4.dat')
C
       PARAMETER(FNFX  =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/home/chepplew/data/sarta/prod_2009/cris/dbase/Coef/profref_trace385_nh3')
       PARAMETER(FNSUN =
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Solar/solardatag4.txt')
C
       PARAMETER(FNTHER=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/thermg4.dat')
       PARAMETER(FNCOFN=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/nte.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/asl/rta/sarta_database/Data_CrIS_apr09/Coef/'
