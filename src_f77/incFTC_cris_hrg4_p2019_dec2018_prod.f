...
C 24 Mar 2021 C Hepplewhite  Production version. dbase: /asl/rta/sarta_coef/Data_CrIS_mar21/
...
C
       PARAMETER(FNCOF1=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2021/cris_hr/feb2020/dbase/Coef/set3.dat')
CC     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set7.dat')
       PARAMETER(FNOPTR=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/n2o.dat')
       PARAMETER(FNNH3 =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/nh3.dat')
C
       PARAMETER(FNFX  =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/fx.txt')
       PARAMETER(FNPREF =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/refprof_400_tra')
       PARAMETER(FNSUN =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Solar/solar_data.txt')
C
       PARAMETER(FNTHER =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/therm.dat')
       PARAMETER(FNCOFN =
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/nte_7term.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
