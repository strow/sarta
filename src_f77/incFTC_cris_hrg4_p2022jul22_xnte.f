...
C      version template    '#.## YYYY-MM-DD <--------comment------->'
       PARAMETER( VSARTA = '2.02 2022-07-01. prod_2022' )
...
C      -----------
       ...
       PARAMETER(MXCNTE = 270)        ! was 264 placeholder
       PARAMETER(NNCOEF = 14)          ! was 7
       PARAMETER(NTEBOT = 10)
...
C
     ...
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/set7.dat')
       PARAMETER(FNOPTR=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/n2o.dat')
       PARAMETER(FNNH3 =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/nh3.dat')
C
       PARAMETER(FNFX  =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/fx.txt')
       PARAMETER(FNPREF =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/refprof_400_tra')
       PARAMETER(FNSUN =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Solar/sol.txt')
C
       PARAMETER(FNTHER =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/therm.dat')
       PARAMETER(FNCOFN =
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/xnte_14term.dat')
C     $ '/home/chepplew/data/sarta/prod_2021/cris_hr/dec2018/dbase/Coef/nte_7term.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/home/chepplew/data/sarta/prod_2022/cris_hr/jul2022/dbase/Coef/'
     $ // 'tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
