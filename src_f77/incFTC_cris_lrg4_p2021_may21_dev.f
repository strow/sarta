...
C  4 Jun 2021 C Hepplewhite  Based on standard template
...
C      version template    '#.## YYYY-MM-DD <--------comment------->'
       PARAMETER( VSARTA = '2.02 2021-05-23. prod_2021' )
       PARAMETER( VSCOEF = 'CrIS g4 0.8/0.4/0.2 cm Hamming May 2021')
...
C
       REAL CO2STD ! standard CO2 PPMV mixing ratio (400 ppm)
...
C      -----------------------------------
       ...
       INTEGER MXCHAN ! max total # of channels (1329)
...
C      Used in part by modules: 12, 11, 10, 9, 8, 7, 6, 5, 3, 4b, 4a
       INTEGER MXCHN1 ! max # of channels for set1 = FWO (591)
...
C      Used in part by modules: 6, 5
       INTEGER MXCHN2 ! max # of channels for set2 = FOW  (130)
...
C      Used in part by modules: 4d, 4c, 3
       INTEGER MXCHN3 ! max # of channels for set3 = FMW  (441)
...
C      Used in part by modules: 2b
       INTEGER MXCHN4 ! max # of channels for set4 = FCOW (34)
...
C      Used in part by modules: 2b, 1b
       INTEGER MXCHN5 ! max # of channels for set5 = BFSW (70)
...
C      Used in part by modules: 1b, 2a
       INTEGER MXCHN6 ! max # of channels for set6 = MFMW (50)
...
C      Used in part by modules: 2a, 1a
       INTEGER MXCHN7 ! max # of channels for set7 = MFBW (13)
...
C      Used in part by modules: 12, 11, 10, 9, 7, 6, 5, 2b, 1b, 2a
       INTEGER MXCHNC ! max # of channels with CO2 pert coefs (was 498)
       INTEGER NCO2   ! number of CO2 pert predictors/coefs (5)
       PARAMETER(MXCHNC = 498)    ! placeholder
       PARAMETER(  NCO2 = 5)
C
C
C      ----------------
C      For variable SO2
C      ----------------
       INTEGER MXCHNS ! max # of channels with SO2 pert coefs (was 211)
       INTEGER   NSO2 ! number of SO2 coefficients
       PARAMETER(MXCHNS = 211)    ! placeholder
       PARAMETER(  NSO2 = 4)
C
C
C      -----------------
C      For variable HNO3
C      -----------------
       INTEGER MXCHNH ! max # of channels with HNO3 pert coefs (was 354)
       INTEGER  NHNO3 ! number of HNO3 coefficients
       PARAMETER(MXCHNH = 354)    ! placeholder
       PARAMETER( NHNO3 = 4)
C
C
C      -----------------
C      For variable N2O
C      -----------------
       INTEGER MXCHNN ! max # of channels with N2O pert coefs (was 247)
       INTEGER   NN2O ! number of N2O coefficients
       PARAMETER(MXCHNN = 247)
       PARAMETER(  NN2O = 7)
C
C      -----------------
C      For variable NH3
C      -----------------
       INTEGER MXCHNA ! max # of channels with NH3 pert coefs (815)
...
C      Used in part by modules:
       INTEGER MXCHNW ! max # of channelss with OPTRAN H2O coefs (480)
...
C      For non-LTE
C      -----------
       INTEGER MXCNTE ! max # of channels for non-LTE (66)
       ...
       PARAMETER(MXCNTE = 66)        ! placeholder
       PARAMETER(NNCOEF = 7)
       PARAMETER(NTEBOT = 10)
...
C
       PARAMETER(FNCOF1=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set3.dat')
CC     $ '/asl/rta/sarta_coef/Data_CrIS_mar21/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/set7.dat')
       PARAMETER(FNOPTR=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/optran.dat')
C
       PARAMETER(FNCO2 =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/n2o.dat')
       PARAMETER(FNNH3 =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/nh3.dat')
C
       PARAMETER(FNFX  =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/fx.txt')
       PARAMETER(FNPREF =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/refprof_400_tra')
       PARAMETER(FNSUN =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Solar/solardata.txt')
C
       PARAMETER(FNTHER =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/therm.dat')
       PARAMETER(FNCOFN =
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/nte_7term.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/home/chepplew/data/sarta/prod_2021/cris_lr/may2021/dbase/Coef/tunmlt.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
