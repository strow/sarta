...
C 1  Jun 2022 C Hepplewhite  Added shortwave CH4 per Scott's original 
...
C
       REAL HDOSTD ! standard HDO depletion abundance (3.1069E-4)
       PARAMETER( HDOSTD = 0.00031069 )
C
       REAL HDOFCT ! vary proportion of HDO in H2O from std depletion
C                  ! (1000: 100% enhancement, 0:std HDO or zero depletion,
C                  -1000: 100% depleted))
       PARAMETER( HDOFCT = -300.0 )
C
...
C
     ...
     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/nh3.dat')
       PARAMETER(FNHDO =
CCC     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/hdo.dat')
