...
C
C    incFTC (basic, optran, co2, so2, nh3, nte)
C
!F77====================================================================
...
C 09 May 2018 C Hepplewhite  add NH3 variables
C    May 2019 C Hepplewhite  add HDO variables
C    Sep 2019 C Hepplewhite  add logicals to control trace gas calcs
