...
! 1  Jun 2022 C Hepplewhite  Added shortwave CH4 per Scott's original
...
!      ---------
              ...
              CHARACTER (LEN=80) :: FNHDO  ! coef HDO
                CHARACTER (LEN=80) :: FNCH4  ! coef s/w CH4
                ...
                PARAMETER(FNHDO =
!CC     $ '/asl/data/sarta_coef/Data_IASI_jun19/Coef/hdo.dat')  &
