...
!    CrIS FSR using airs.std layering
!       build: p2025.jul2022
!    incFTC
...
PARAMETER( VSCOEF = 'CrIS g4 std 0.8/0.8/0.8cm Hamming Jan 2025')
PARAMETER( VTUNNG = 'none' )
    
! -------------------------------
! include variables and contants.
! --------------------------------
...
!      ---------
      ...
      PARAMETER(FNCOF1=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set1.dat')
      PARAMETER(FNCOF2=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set2.dat')
      PARAMETER(FNCOF3=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set3.dat')
      PARAMETER(FNCOF4=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set4.dat')
      PARAMETER(FNCOF5=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set5.dat')
      PARAMETER(FNCOF6=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set6.dat')
      PARAMETER(FNCOF7=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/set7.dat')
      PARAMETER(FNOPTR=  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/optran.dat')
               
      PARAMETER(FNCO2 =  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/co2.dat')
      PARAMETER(FNSO2 =  &
      ...
      PARAMETER(FNPREF =  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/refprof_400ppm')
      PARAMETER(FNSUN =  &
          '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Solar/solar.txt')
...
! Tuning filename
      ...
      PARAMETER(FNTMLT=  &
        '/home/chepplew/data/sarta/prod_2025/cris_hr/jul2022/dbase/Coef/tunmlt_ones.txt')
