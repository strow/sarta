...
! 25 Apr 2001 Scott Hannon      Reversed direction for sarta
...
!***********************************************************************
       COMMON /COMLEV/ PLEV
!SAVE
!      This version is for the 100 AIRS layers (101 levels)
!      Note: SARTA version with pressure levels sorted top down
!
       REAL PLEV(101)
!
       DATA  ( PLEV(II), II = 1, 50 ) &
