...
!      Calculate TAU for set 1 thru 7
                                                  ...
                                                                   6LOPMIN, LOPMAX, LOPLOW, LOPUSE,  &
                                                                   6WAOP,   DAOP,  WAANG,    TAU,   TAUZ)
                                                                
                                                                CALL XCALT4(INDCHN,   LBOT,  NCHN4, CLIST4,  &
                                                                   6COEF4, FIXMUL, CONPRD, FPRED4, CPRED4, OPRED4, WPRED4,  &
                                                                   6TRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6TAU,   TAUZ )
                                                                
                                                                CALL XCALT5(INDCHN,   LBOT,  NCHN5, CLIST5,  &
                                                                   6COEF5, FIXMUL, CONPRD, FPRED5, WPRED5, OPRED5,  &
                                                                   6TRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6TAU,   TAUZ )
                                                                
                                                                CALL XCALT6(INDCHN,   LBOT,  NCHN6, CLIST6,  &
                                                                   6COEF6, FIXMUL, CONPRD, FPRED6, WPRED6, OPRED6, DPRED, TRCPRD,  &
                                                                   6INDCO2, COFCO2, CO2MLT, INDSO2, COFSO2, SO2MLT,  &
                                                                INDN2O, COFN2O, N2OMLT, INDHDO  COFHDO, HDOMLT,  TAU,  TAUZ )
                                                                  
                                                                  CALL XCALT7(INDCHN,   LBOT,  NCHN7, CLIST7,  &
                                                                   6  COEF7, FIXMUL, CONPRD, FPRED7, WPRED7, OPRED7,  &
...
!         ---------------------------------------------
                                                                   6
                                                                   6CALL SUNPAR ( LBOT,  &
                                                                   6   HRTEMP, RWAMNT, ROAMNT, RCAMNT,  &
                                                                   6   HTEMP,  WAMNT,  OAMNT,  CAMNT,  &
                                                                   6   HRPRES,  SECSUN, CONPRD,  &
                                                                   6   HFPRED4, FPRED5, FPRED6, FPRED7,  &
                                                                   6   HWPRED4, WPRED5, WPRED6, WPRED7,  &
                                                                   6   HOPRED4, OPRED5, OPRED6, OPRED7,  &
                                                                   6   HCPRED4, TRCPRD )
                                                                   6
!         --------------------------------------------
...
!         Calc fake TAUZSN for sets 1, 2, and 3
                                                                   6CALL FAKETZ( NFAKE, INDFAK, LBOT, TAUZ, SECANG,  &
                                                                   6   HSECSUN, TAUZSN)
                                                                   6
                                                                   6
!         Calculate TAUZSN for sets 4 thru 7
                                                                   6
                                                                   6CALL XCALT4(INDCHN,   LBOT,  NCHN4, CLIST4,  &
                                                                   6   HCOEF4, FIXMUL, CONPRD, FPRED4, CPRED4, OPRED4, WPRED4,  &
                                                                   6   HTRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6   HTAUZSN, TAUZSN )
!            ^^^^^^  ^^^^^^
!            dummy   actual
                                                                   6
                                                                   6CALL XCALT5(INDCHN,   LBOT,  NCHN5, CLIST5,  &
                                                                   6   HCOEF5, FIXMUL, CONPRD, FPRED5, WPRED5, OPRED5,  &
                                                                   6   HTRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6   HTAUZSN, TAUZSN )
                                                                   6
                                                                   6CALL XCALT6(INDCHN,   LBOT,  NCHN6, CLIST6,  &
                                                                   6   HCOEF6, FIXMUL, CONPRD, FPRED6, WPRED6, OPRED6, DPRED,  &
                                                                   6   HTRCPRD, INDCO2, COFCO2, CO2MLT, INDSO2, COFSO2, SO2MLT,  &
                                                                   6INDN2O, COFN2O, N2OMLT, INDHDO  COFHDO, HDOMLT, TAUZSN, TAUZSN )
                                                                   6  
                                                                   6  CALL XCALT7(INDCHN,   LBOT,  NCHN7, CLIST7,  &
                                                                   6   H COEF7, FIXMUL, CONPRD, FPRED7, WPRED7, OPRED7,  &
                                                                   6   H TRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6   H TAUZSN, TAUZSN )
                                                                   6  
                                                                   6  
                                                                   6  IF (SUNFDG > 1.0001) THEN
                                                                   6   HDO I=1,NCHAN
                                                                   6   H DO L=1,LBOT
                                                                   6   H  $TAUZSN(L,I)=TAUZSN(L,I)*SUNFDG
                                                                   6   H  $ENDDO
                                                                   6   H  $  ENDDO
                                                                   6   H  $  END IF
                                                                   6   H  $  
...
!      Get basic cloud parameters from input RTP
                                                                   6   H  $      CALL GETCLD( IPROF, HEAD, PROF,  &
                                                                   6   H  $         7LBLAC1, CTYPE1, CFRAC1, CPSIZ1, CPRTO1, CPRBO1, CNGWA1,  &
                                                                   6   H  $         7XCEMI1, XCRHO1, CSTMP1,  &
                                                                   6   H  $         7LBLAC2, CTYPE2, CFRAC2, CPSIZ2, CPRTO2, CPRBO2, CNGWA2,  &
                                                                   6   H  $         7XCEMI2, XCRHO2, CSTMP2, CFRA12, FCLEAR, CFRA1X, CFRA2X )
                                                                   6   H  $      IF (DEBUG) THEN
                                                                   6   H  $        PRINT *,'getcld ',IPROF,CTYPE1, CFRAC1, CPSIZ1, CPRTO1,  &
                                                                   6   H  $         7  CPRBO1, CNGWA1,CFRA1X
                                                                   6   H  $      END IF
!      ---------------------------------------------------
!      Set the emissivity & reflectivity for every channel
!      ---------------------------------------------------
                                                                   6   H  $      CALL SETEMS( NCHAN, NEMIS, FREQ, FEMIS, XEMIS, XRHO,  &
                                                                   6   H  $         7XCEMI1, XCRHO1, XCEMI2, XCRHO2, LRHOT,  &
                                                                   6   H  $         7EMIS, RHOSUN, RHOTHR, CEMIS1, CRHOS1, CRHOT1,  &
                                                                   6   H  $         7CEMIS2, CRHOS2, CRHOT2)
                                                                   6   H  $      
!       print *,CFRAC1,CFRAC2,CFRA12,LBLAC1,LBLAC2
                                                                   6   H  $      
!      Check and prepare (top) cloud1
                                                                   6   H  $      IF (CFRAC1 > 0.0) THEN
                                                                   6   H  $        IF (LBLAC1) THEN
                                                                   6   H  $         7CALL BKPREP(IPROF, 1, CTYPE1, CFRAC1, CPRTO1,  &
                                                                   6   H  $         7   6LBOT, PSURF, PLEV, PLAY, TEMP, LCTOP1, TCTOP1,  &
                                                                   6   H  $         7   6TEMPC1, CLRT1)
                                                                   6   H  $         7IF (CSTMP1 > 0.0) TCTOP1=CSTMP1
                                                                   6   H  $        ELSE
!            Determine which lookup table to use
                                                                   6   H  $         7CALL GETMIE(CTYPE1,MIETYP,INDMI1,IERR1)
!            Prepare selected lookup table for given cpsize
                                                                   6   H  $         7CALL CCPREP( NCHAN, LBOT, INDMI1, MIENPS,  &
                                                                   6   H  $         7   6CNGWA1, CPSIZ1, CPRTO1, CPRBO1, PLEV, TEMP, SECANG,  &
                                                                   6   H  $         7   6SECSUN, MIEPS, MIEABS, MIEEXT, MIEASY, LCBOT1, LCTOP1,  &
                                                                   6   H  $         7   6CLRB1, CLRT1, TCBOT1, TCTOP1, MASEC1, MASUN1,  &
                                                                   6   H  $         7   6CFRCL1, G_ASY1, NEXTO1, NSCAO1 )
                                                                   6   H  $        END IF
                                                                   6   H  $      END IF
                                                                   6   H  $      
!      Check and prepare (bottom) cloud2
                                                                   6   H  $      IF (CFRAC2 > 0.0) THEN
                                                                   6   H  $        IF (LBLAC2) THEN
                                                                   6   H  $         7CALL BKPREP(IPROF, 2, CTYPE2, CFRAC2, CPRTO2,  &
                                                                   6   H  $         7   6LBOT, PSURF, PLEV, PLAY, TEMP, LCTOP2, TCTOP2,  &
                                                                   6   H  $         7   6TEMPC2, CLRT2)
                                                                   6   H  $         7IF (CSTMP2 > 0.0) TCTOP2=CSTMP2
                                                                   6   H  $        ELSE
!            Determine which lookup table to use
                                                                   6   H  $         7CALL GETMIE(CTYPE2,MIETYP,INDMI2,IERR2)
!            Prepare lookup data for cloud2
                                                                   6   H  $         7CALL CCPREP( NCHAN, LBOT, INDMI2, MIENPS,  &
                                                                   6   H  $         7   6CNGWA2, CPSIZ2, CPRTO2, CPRBO2, PLEV, TEMP, SECANG,  &
                                                                   6   H  $         7   6SECSUN, MIEPS, MIEABS, MIEEXT, MIEASY, LCBOT2, LCTOP2,  &
                                                                   6   H  $         7   6CLRB2, CLRT2, TCBOT2, TCTOP2, MASEC2, MASUN2,  &
                                                                   6   H  $         7   6CFRCL2, G_ASY2, NEXTO2, NSCAO2 )
                                                                   6   H  $        END IF
                                                                   6   H  $      ELSE
...
!ccccccccccccccccccccccccccccccccccc
                                                                   6   H  $      
                                                                   6   H  $      SUNFAC=SUNCOS*PI*(RADSUN/DISTES)**2
...
!         Radiation constants for current channel
                                                                   6   H  $        C1V3=C1*(FREQ(I)**3)
                                                                   6   H  $        C2V=C2*FREQ(I)
                                                                   6   H  $        
!         Calculate Planck & clear airs trans for full layers
                                                                   6   H  $        DO L=1,LBOT-1
                                                                   6   H  $         7RPLNCK(L)=C1V3/( EXP( C2V/TEMP(L) ) - 1.0 )
                                                                   6   H  $         7TRANL(L)=QIKEXP( -TAU(L,I) )
                                                                   6   H  $         7ENDDO
!         Note: TEMP(LBOT) already adjusted for bottom fractional layer
                                                                   6   H  $         7  RPLNCK(LBOT)=C1V3/( EXP( C2V/TEMP(LBOT) ) - 1.0 )
                                                                   6   H  $         7  
!         Calculate clear airs trans for bottom fractional layer
                                                                   6   H  $         7  RJUNK1=-TAU(LBOT,I)*BLMULT
                                                                   6   H  $         7  TRANL(LBOT)=QIKEXP( RJUNK1 )
                                                                   6   H  $         7  TRANL(LBOT)=QIKEXP( RJUNK1 )
                                                                   6   H  $         7  TRANZ(I)=QIKEXP( RJUNK1 - TAUZ(LBOT-1,I) )
                                                                   6   H  $         7  TRANS(I)=QIKEXP( BLMULT*(TAUZSN(LBOT-1,I)-TAUZSN(LBOT,I)) -  &
                                                                   6   H  $         7   6  TAUZSN(LBOT-1,I) )
                                                                   6   H  $         7  
!         Planck for surface
                                                                   6   H  $         7  RSURFE=EMIS(I)*C1V3/( EXP( C2V/TSURF ) - 1.0 )
                                                                   6   H  $         7  
!         Calculate clear radiance
                                                                   6   H  $         7  IF (FCLEAR > 0.0) THEN
                                                                   6   H  $         7   6CALL CALRAD0( DOSUN, I, LBOT, RPLNCK, RSURFE, SECANG,  &
                                                                   6   H  $         7   6   HTRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   HRHOTHR, LABOVE, COEFF, RAD0 )
                                                                   6   H  $         7  ELSE
                                                                   6   H  $         7   6RAD0=0.0
                                                                   6   H  $         7  END IF
                                                                   6   H  $         7  
!         Store original values
                                                                   6   H  $         7  VSTORE(1)=TRANL(LCTOP2)
                                                                   6   H  $         7  VSTORE(2)=TRANZ(I)
                                                                   6   H  $         7  VSTORE(3)=TRANS(I)
                                                                   6   H  $         7  VSTORE(4)=RHOTHR(I)
                                                                   6   H  $         7  VSTORE(5)=RHOSUN(I)
                                                                   6   H  $         7  VSTORE(6)=RPLNCK(LCTOP2)
!         Updates for new surface if bottom cloud2 is black
                                                                   6   H  $         7  IF (CFRAC2 > 0.0 .AND. LBLAC2) THEN
                                                                   6   H  $         7   6RJUNK1=-TAU(LCTOP2,I)*CLRT2
                                                                   6   H  $         7   6TRANL(LCTOP2)=QIKEXP( RJUNK1 )
                                                                   6   H  $         7   6TRANZ(I)=QIKEXP( RJUNK1 - TAUZ(LCTOP2-1,I) )
                                                                   6   H  $         7   6TRANS(I)=QIKEXP( CLRT2*(TAUZSN(LCTOP2-1,I)-  &
                                                                   6   H  $         7   6   HTAUZSN(LCTOP2,I)) - TAUZSN(LCTOP2-1,I) )
                                                                   6   H  $         7   6RSURFC=CEMIS2(I)*C1V3/( EXP( C2V/TCTOP2 ) - 1.0 )
                                                                   6   H  $         7   6RHOTHR(I)=CRHOT2(I)
                                                                   6   H  $         7   6RHOSUN(I)=CRHOS2(I)
                                                                   6   H  $         7   6RPLNCK(LCTOP2)=C1V3/( EXP( C2V/TEMPC2 ) - 1.0 )
!             RSURFC=C1V3/( EXP( C2V/TEMPC2 ) - 1.0 )
                                                                   6   H  $         7  END IF
                                                                   6   H  $         7  
!         Calculate bottom cloud2 radiance
                                                                   6   H  $         7  IF (CFRA2X > 0.0) THEN
                                                                   6   H  $         7   6IF (LBLAC2) THEN
                                                                   6   H  $         7   6  CALL CALRAD0( DOSUN, I, LCTOP2, RPLNCK, RSURFC, SECANG,  &
                                                                   6   H  $         7   6   H TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, RADC2 )
                                                                   6   H  $         7   6ELSE
                                                                   6   H  $         7   6  CALL CALRAD1( DOSUN, I, LBOT, RPLNCK, RSURFE, SECANG,  &
                                                                   6   H  $         7   6   H TAU, TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, CFRCL2, MASEC2, MASUN2, COSDAZ,  &
                                                                   6   H  $         7   6   H NEXTO2, NSCAO2, G_ASY2, LCTOP2, LCBOT2, RADC2 )
                                                                   6   H  $         7   6END IF
                                                                   6   H  $         7  ELSE
                                                                   6   H  $         7   6RADC2=0.0
                                                                   6   H  $         7  END IF
...
!         Calculate combined cloud1+cloud2 radiance
                                                                   6   H  $         7  IF (CFRA12 > 0.0) THEN
                                                                   6   H  $         7   6IF (LBLAC2) THEN
                                                                   6   H  $         7   6  CALL CALRAD1( DOSUN, I, LCTOP2, RPLNCK, RSURFC, SECANG,  &
                                                                   6   H  $         7   6   H TAU, TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, CFRCL1, MASEC1, MASUN1, COSDAZ,  &
                                                                   6   H  $         7   6   H NEXTO1, NSCAO1, G_ASY1, LCTOP1, LCBOT1, RADC12 )
                                                                   6   H  $         7   6ELSE
                                                                   6   H  $         7   6  CALL CALRAD2( DOSUN, I, LBOT, RPLNCK, RSURFE, SECANG,  &
                                                                   6   H  $         7   6   H TAU, TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, CFRCL1, MASEC1, MASUN1, NEXTO1,  &
                                                                   6   H  $         7   6   H NSCAO1, G_ASY1, LCTOP1, LCBOT1, CFRCL2, MASEC2, MASUN2,  &
                                                                   6   H  $         7   6   H COSDAZ, NEXTO2, NSCAO2, G_ASY2, LCTOP2, LCBOT2, RADC12 )
                                                                   6   H  $         7   6END IF
                                                                   6   H  $         7  ELSE
                                                                   6   H  $         7   6RADC12=0.0
                                                                   6   H  $         7  END IF
...
!         Restore original values
                                                                   6   H  $         7  TRANL(LCTOP2)=VSTORE(1)
                                                                   6   H  $         7  TRANZ(I)=VSTORE(2)
                                                                   6   H  $         7  TRANS(I)=VSTORE(3)
                                                                   6   H  $         7  RHOTHR(I)=VSTORE(4)
                                                                   6   H  $         7  RHOSUN(I)=VSTORE(5)
                                                                   6   H  $         7  RPLNCK(LCTOP2)=VSTORE(6)
!         Updates for new surface if top cloud1 is black
                                                                   6   H  $         7  IF (CFRAC1 > 0.0 .AND. LBLAC1) THEN
                                                                   6   H  $         7   6RJUNK1=-TAU(LCTOP1,I)*CLRT1
                                                                   6   H  $         7   6TRANL(LCTOP1)=QIKEXP( RJUNK1 )
                                                                   6   H  $         7   6TRANZ(I)=QIKEXP( RJUNK1 - TAUZ(LCTOP1-1,I) )
                                                                   6   H  $         7   6TRANS(I)=QIKEXP( CLRT1*(TAUZSN(LCTOP1-1,I)-  &
                                                                   6   H  $         7   6   HTAUZSN(LCTOP1,I)) - TAUZSN(LCTOP1-1,I) )
                                                                   6   H  $         7   6RSURFC=CEMIS1(I)*C1V3/( EXP( C2V/TCTOP1 ) - 1.0 )
                                                                   6   H  $         7   6RHOTHR(I)=CRHOT1(I)
                                                                   6   H  $         7   6RHOSUN(I)=CRHOS1(I)
                                                                   6   H  $         7   6RPLNCK(LCTOP1)=C1V3/( EXP( C2V/TEMPC1 ) - 1.0 )
!             RSURFC=C1V3/( EXP( C2V/TEMPC1 ) - 1.0 )
                                                                   6   H  $         7  END IF
                                                                   6   H  $         7  
!         Calculate top cloud1 radiance
                                                                   6   H  $         7  IF (CFRA1X > 0.0) THEN
                                                                   6   H  $         7   6IF (LBLAC1) THEN
                                                                   6   H  $         7   6  CALL CALRAD0( DOSUN, I, LCTOP1, RPLNCK, RSURFC, SECANG,  &
                                                                   6   H  $         7   6   H TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, RADC1 )
                                                                   6   H  $         7   6ELSE
                                                                   6   H  $         7   6  CALL CALRAD1( DOSUN, I, LBOT, RPLNCK, RSURFE, SECANG,  &
                                                                   6   H  $         7   6   H TAU, TRANL, TRANZ, SUNFAC, HSUN, TRANS, RHOSUN,  &
                                                                   6   H  $         7   6   H RHOTHR, LABOVE, COEFF, CFRCL1, MASEC1, MASUN1, COSDAZ,  &
                                                                   6   H  $         7   6   H NEXTO1, NSCAO1, G_ASY1, LCTOP1, LCBOT1, RADC1 )
                                                                   6   H  $         7   6END IF
                                                                   6   H  $         7  ELSE
                                                                   6   H  $         7   6RADC1=0.0
                                                                   6   H  $         7  END IF
...
!         Total the clear & various cloudy radiances
                                                                   6   H  $         7  RAD(I)=RAD0*FCLEAR + RADC1*CFRA1X + RADC2*CFRA2X +  &
                                                                   6   H  $         7   6  RADC12*CFRA12
                                                                   6   H  $         7  
!cc this block for testing
                                                                   6   H  $         7  IF (I == 1291) THEN
...
!      but clouds are generally below the altitude where nonLTE occurs.
                                                                   6   H  $         7   6IF (DOSUN) THEN
                                                                   6   H  $         7   6  CALL CALNTE ( INDCHN, TEMP, SUNCOS, SCOS1, SECANG(1),  &
                                                                   6   H  $         7   6   H NCHNTE, CLISTN, COEFN, CO2TOP, RAD )
                                                                   6   H  $         7   6END IF
                                                                   6   H  $         7   6
                                                                   6   H  $         7   6
!      -------------------
!      Output the radiance
!      -------------------
                                                                   6   H  $         7   6CALL WRTRTP(IPROF, IOPCO, NCHAN, RAD, PROF)
                                                                   6   H  $         7   6
                                                                   6   H  $         7   6
!      ----------------------
!      End loop over profiles
!      ----------------------
                                                                   6   H  $         7   6IPROF=IPROF + 1  ! increment profile counter
...
!      Close the RTP files
!      -------------------
                                                                   6   H  $         7   69999  ISTAT=rtpclose(IOPCI)
                                                                   6   H  $         7   6ISTAT=rtpclose(IOPCO)
                                                                   6   H  $         7   6
                                                                   6   H  $         7   6STOP
                                                                   6   H  $         7  END PROGRAM SARTA
