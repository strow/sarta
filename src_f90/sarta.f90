...
!    SARTA version with trace gases and HDO
...
!      -----------------------------------
                                                  ...
                                                                   6WAANG, LOPMIN, LOPMAX, LOPUSE, H2OPRD, LOPLOW, DAOP )
                                                                
                                                                IF (DEBUG) WRITE(6,'(A)') 'sarta: completed CALOWP'
                                                                IF (DEBUG) WRITE(6,'(A,X,I6,X,I6)') 'sarta: LOPLOW(1,LBOT): ', LOPLOW(1),LOP
                                                              END IF
!      ----------------------------------
...
!      Calculate TAU for set 1 thru 7
                                                  ...
                                                                   6INDH2O, H2OPRD, COFH2O, LOPMIN, LOPMAX, LOPLOW,  &
                                                                   6LOPUSE,   WAOP,   DAOP, WAANG,     TAU,   TAUZ)
                                                                
                                                                IF (DEBUG) WRITE(6,'(A)') 'sarta: completed CALT1'
                                                                CALL CALT2( INDCHN, NLAY, BLMULT, NCHN2, CLIST2, COEF2,  &
                                                                   6FIXMUL, CONPRD, FPRED2, OPRED2, WPRED2, DPRED, TRCPRD,  &
                                                                   6INDCO2, COFCO2, CO2MLT, INDSO2, COFSO2, SO2MLT,  &
                                                                   6INDHNO, COFHNO, HNOMLT, INDN2O, COFN2O, N2OMLT,  &
                                                  ...
                                                                   6  FIXMUL, CONPRD, FPRED3, MPRED3, WPRED3, DPRED,  TRCPRD,  &
                                                                   6  INDSO2, COFSO2, SO2MLT, INDHNO, COFHNO, HNOMLT,  &
                                                                   6  INDN2O, COFN2O, N2OMLT, INDNH3, COFNH3, NH3MLT,  &
                                                                  INDHDO  COFHDO, HDOMLT, INDH2O, H2OPRD, COFH2O,  &
                                                                   6   HLOPMIN, LOPMAX, LOPLOW, LOPUSE,  &
                                                                   6   HWAOP,   DAOP,   WAANG,  TAU,    TAUZ)
                                                                   6
                                                                   6LTAU=.TRUE.
                                                                   6XZ=1.0
                                                                   6
                                                                   6CALL CALT4(  LTAU, INDCHN,   LBOT, BLMULT,  NCHN4, CLIST4,  &
                                                                   6   HCOEF4, FIXMUL, CONPRD, FPRED4, CPRED4, OPRED4, WPRED4,  &
                                                                   6   HTRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6   HXZ,    TAU,   TAUZ )
                                                                   6
                                                                   6CALL CALT5(  LTAU, INDCHN,   LBOT, BLMULT,  NCHN5, CLIST5,  &
                                                                   6   HCOEF5, FIXMUL, CONPRD, FPRED5, WPRED5, OPRED5,  &
                                                                   6   HTRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6   HXZ,    TAU,   TAUZ )
                                                                   6
                                                                   6CALL CALT6(  LTAU, INDCHN,   LBOT, BLMULT,  NCHN6, CLIST6,  &
                                                                   6   HCOEF6, FIXMUL, CONPRD, FPRED6, WPRED6, OPRED6, DPRED, TRCPRD,  &
                                                                   6   HINDCO2, COFCO2, CO2MLT, INDSO2, COFSO2, SO2MLT,  &
                                                                   6INDN2O, COFN2O, N2OMLT, INDHDO  COFHDO, HDOMLT,  &
                                                                   6   H XZ,     TAU,    TAUZ )
                                                                   6  
                                                                   6  CALL CALT7(  LTAU, INDCHN,   LBOT, BLMULT,  NCHN7, CLIST7,  &
                                                                   6   H COEF7, FIXMUL, CONPRD, FPRED7, WPRED7, OPRED7, DPRED,  &
                                                                   6   H TRCPRD, INDCO2, COFCO2, CO2MLT, INDN2O, COFN2O, N2OMLT,  &
                                                                   6  INDHDO  COFHDO, HDOMLT, XZ,    TAU,   TAUZ )
                                                                   6   H
                                                                   6   HIF (DOSUN) THEN
!         ---------------------------------------------
...
!         ---------------------------------------------
                                                  ...
                                                                   6   H  $  CPRED4, TRCPRD )
                                                                   6   H IF (DEBUG)  PRINT*, 'sarta: completed SUNPAR'
!         --------------------------------------------
!         Calculate the layer transmittances *for sun*
!         --------------------------------------------
                                                                   6   H 
!         Calc fake TAUZSN for sets 1, 2, and 3
                                                                   6   H RJUNK1=SUNFDG*SECSUN(LBOT)
                                                                   6   H CALL FAKETZ( NFAKE, INDFAK, TAUZ, SECANG(LBOT),  &
                                                                   6   H  $  RJUNK1, TAUZSN)
                                                                   6   H 
