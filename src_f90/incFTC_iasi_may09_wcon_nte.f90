...
PARAMETER(FNCOF1= '/asl/data/sarta_database/Data_IASI_may09/Coef/set1.dat')
PARAMETER(FNCOF2= '/asl/data/sarta_database/Data_IASI_may09/Coef/set2.dat')
PARAMETER(FNCOF3= '/asl/data/sarta_database/Data_IASI_may09/Coef/set3.dat')
PARAMETER(FNCOF4= '/asl/data/sarta_database/Data_IASI_may09/Coef/set4.dat')
PARAMETER(FNCOF5= '/asl/data/sarta_database/Data_IASI_may09/Coef/set5.dat')
PARAMETER(FNCOF6= '/asl/data/sarta_database/Data_IASI_may09/Coef/set6.dat')
PARAMETER(FNCOF7= '/asl/data/sarta_database/Data_IASI_may09/Coef/set7.dat')

PARAMETER(FNOPTR= '/asl/data/sarta_database/Data_IASI_may09/Coef/optran.dat')

PARAMETER(FNCO2 = '/asl/data/sarta_database/Data_IASI_may09/Coef/co2.dat')
PARAMETER(FNSO2 = '/asl/data/sarta_database/Data_IASI_may09/Coef/so2.dat')
PARAMETER(FNHNO3 = '/asl/data/sarta_database/Data_IASI_may09/Coef/hno3.dat')
PARAMETER(FNN2O = '/asl/data/sarta_database/Data_IASI_may09/Coef/n2o.dat')

PARAMETER(FNTHER= '/asl/data/sarta_database/Data_IASI_may09/Coef/therm.dat')
PARAMETER(FNCOFN=  &
    '/asl/data/sarta_database/Data_IASI_may09/Coef/nte_7term.dat')
PARAMETER(FNFX  = '/asl/data/sarta_database/Data_IASI_may09/Coef/fx.txt')
PARAMETER(FNPREF=  &
...
PARAMETER(FNTMLT= '/asl/data/sarta_database/Data_IASI_may09/Coef/'  &
    // 'tunmlt_wcon_nte.txt')
